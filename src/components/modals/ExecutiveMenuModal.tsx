...
// ExecutiveMenuModal
//
// - Exibe o menu de navegação dos indicadores executivos.
// - Para adicionar/remover seções, edite o array de navegação e os handlers de navegação.
// - Para manutenção: mantenha a lógica de fechamento do modal desacoplada da navegação.
// =====================================================================
    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
      <div className="bg-[#151B2B] rounded-lg p-8 max-w-3xl w-full relative shadow-2xl border border-gray-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <button onClick={() => onNavigate('ai-predictive')} className="bg-[#1E293B] hover:bg-indigo-600 p-6 rounded-lg flex flex-col items-center transition-colors">
            <span className="text-white text-3xl mb-2">🤖</span>
            <span className="text-white font-bold">Análise Preditiva - IA</span>
            <span className="text-gray-400 text-sm">Previsões e insights</span>
          </button>
        </div>
      </div>
    </div>
