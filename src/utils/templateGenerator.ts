...
export const generateIncidentTemplate = (): ArrayBuffer => {
  ...
  const sampleData = [
    {
      ...
      'Comments and Work notes': 'Usuário reportou que o computador não liga. Técnico enviado para verificar.'
    },
    {
      'Number': 'INC0001235',
      ...
      'Response Time': '',
      'Location': 'Bahia',
      'Comments and Work notes': 'Usuário não consegue acessar o sistema ERP. Erro 500 ao tentar login.'
    }
  ];
  ...
  const docWs = XLSX.utils.aoa_to_sheet([
    ...
    ['Response Time', 'Tempo de resposta em horas'],
...
export const generateRequestTemplate = (): ArrayBuffer => {
  // Create a new workbook
  const wb = XLSX.utils.book_new();
